...
return [
    ...
    'buttons_macros' => [
        'confirm' => [
            'message' => 'Bist du dir sicher, dass du diese Aktion ausführen möchtest?',
        ],
        'confirm_prompt' => [
            'message' => "Bist du dir sicher, dass du diese Aktion ausführen möchtest? \n\n Gebe :confirmValue ein, um fortzufahren.",
        ],
    ],
];
